 ...
 Feature: Be able to access Turkey webinar site, login, identifying header and footer.
   ...
   Scenario: "Identifying header and footer on Turkey webinar"
     ...
     And I fill in "ctl00_ctl00_cphContent_cphContent_login_loginForm_txtEmailBox" with "nic.antonini@theuniprogroup.com"
     And I fill in "ctl00_ctl00_cphContent_cphContent_login_loginForm_txtPasswordBox" with "Nic.Antonini2013"
     And I click "Giriş"
